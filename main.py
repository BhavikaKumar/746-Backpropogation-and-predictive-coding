...
if __name__ == '__main__':
    ...
    plt.plot(epochs,accuracies, label="Predictive Coding on training dataset")
    plt.plot(epochs,test_accuracies, label="Predictive Coding on test dataset")
    plt.xlabel("Epoch")
    plt.ylabel("Accuracy")
    plt.title("Accuracy for Predictive Coding on CIFAR-10 dataset")
    plt.legend()
    plt.show()
